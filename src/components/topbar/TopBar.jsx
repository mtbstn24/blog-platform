        ...
        <div className="top">
            ...
            <div className="topCenter" >
                <ul className="topList" >
                    ...
                    <li className="topListItem" ><Link to="/settings" className="link" >ABOUT</Link></li>
